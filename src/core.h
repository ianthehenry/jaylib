...
static Janet cfun_GetMouseRay(int32_t argc, Janet *argv) {
    ...
    return jaylib_wrap_ray(GetMouseRay(position, *camera));
}
...
static Janet cfun_ColorFromHSV(int32_t argc, Janet *argv) {
    ...
    float s = (float) janet_getnumber(argv, 1);
    float v = (float) janet_getnumber(argv, 2);
    return jaylib_wrap_color(ColorFromHSV(h, s, v));
}
...
static Janet cfun_ColorToRGB(int32_t argc, Janet *argv) {
    janet_fixarity(argc, 1);
    Color color = jaylib_getcolor(argv, 0);
    return jaylib_wrap_color_rgb(color);
}

static Janet cfun_ColorToRGBA(int32_t argc, Janet *argv) {
    janet_fixarity(argc, 1);
    Color color = jaylib_getcolor(argv, 0);
...
static JanetReg core_cfuns[] = {
    ...
    {"color-to-rgba", cfun_ColorToRGBA, NULL},
    {"fade", cfun_Fade, NULL},
